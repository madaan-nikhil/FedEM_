...
class CentralizedAggregator(Aggregator):
    ...
    def __init__(self, clients, global_learners_ensemble, log_freq, global_train_logger, global_test_logger, sampling_rate=1, sample_with_replacement=False, test_clients=None, verbose=0, seed=None,aggregation_op=None, *args, **kwargs):
    ...
    def mix(self, replace = False):
        ...
        for learner_id, learner in enumerate(self.global_learners_ensemble):
            ...
            if self.aggregation_op is None:
                ...
                byzantine_robust_aggregate_median(learners, learner)
                ...
                byzantine_robust_aggregate_krum(learners, learner)
